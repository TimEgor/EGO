...
function(ego_editor_config TARGET_NAME)
    ...
    set(TPL_SIMULATION_RENDER_PLUGIN)
    ...
    if (TARGET EgoDefaultRender)
        set(TPL_SIMULATION_RENDER_PLUGIN "$<TARGET_FILE:EgoDefaultRender>")
        add_dependencies(${TARGET_NAME} EgoDefaultRender)
    endif()

    if (TARGET EgoDefaultGuiRender)
        set(TPL_EDITOR_RENDER_PLUGIN "$<TARGET_FILE:EgoDefaultGuiRender>")
    ...
    set(
        EGO_EDITOR_RUNTIME_SIMULATION_RENDER_PLUGIN
    ...
    install(CODE
        ...
        set(TPL_SIMULATION_RENDER_PLUGIN \"${EGO_EDITOR_RUNTIME_SIMULATION_RENDER_PLUGIN}\")
