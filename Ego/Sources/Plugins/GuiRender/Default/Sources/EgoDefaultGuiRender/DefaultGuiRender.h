...
namespace ego::gui::default_gui_render
{
    ...
    private:
        ...
        {
            DrawData m_drawData;
            gpu::BufferPointer m_vertexBuffer = nullptr;
        ...
        bool renderViewport(const gpu::TextureViewPointer& _targetView, const gpu::Texture2DPointer& _targetTexture, const ViewportResources& _resources);
        bool renderDrawData(const gpu::Texture2DSize& _targetSize, const ViewportResources& _resources) const;
        gpu::Texture2DPointer resolveTargetTexture(const gpu::TextureViewPointer& _targetView) const;
        ...
        gpu::FencePointer m_frameFence = nullptr;
        gpu::Fence::FenceValue m_frameFenceValue = 0;

        gpu::VertexShaderPointer m_vertexShader = nullptr;
        gpu::PixelShaderPointer m_pixelShader = nullptr;
        gpu::SamplerPointer m_linearSampler = nullptr;
        gpu::SamplerPointer m_nearestSampler = nullptr;
        gpu::BindingLayoutPointer m_bindingLayout = nullptr;
