...
#define EGO_MODULE(_NAME, _INIT_FUNC, _RELEASE_FUNC)   \
    static ego::PluginModuleRegistrator PluginModuleRegestrator_##_NAME(_INIT_FUNC, _RELEASE_FUNC);

#define EGO_CORE_MODULE()                                                                           \
    extern "C" EGO_DYNAMIC_LIB_EXPORT void __cdecl EGO_MODULE_INIT_FUNC(                            \
        const ego::PluginModuleInfo& _info,                                                         \
        const ego::PluginModuleBindingBridge& _bindings                                             \
    )                                                                                               \
    {                                                                                               \
