...
#define EGO_MODULE_ENTRY()                                                                                                                                                         \
    extern "C" EGO_DYNAMIC_LIB_EXPORT void __cdecl EGO_MODULE_INIT_FUNC(const ego::PluginModuleInfo& _info, const ego::subsystem::SubsystemRegistryPointer& _subsystemRegistry)    \
    {                                                                                                                                                                              \
        EGO_CHECK_RETURN(_subsystemRegistry);                                                                                                                                      \
        EGO_CHECK_RETURN(ego::subsystem::SubsystemLocator::GetInstance().bind(_subsystemRegistry));                                                                                \
                                                                                                                                                                                   \
    ...
    {                                                                                                                                                                              \
        ego::PluginModuleState& moduleState = ego::GetPluginModuleState();                                                                                                         \
        moduleState.release();                                                                                                                                                     \
        ego::subsystem::SubsystemLocator::GetInstance().unbind();                                                                                                                  \
    }
