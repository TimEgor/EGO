...
ego::gui::ImGuiTextureStorage::~ImGuiTextureStorage()
{
    release();
}

bool ego::gui::ImGuiTextureStorage::synchronize(ImTextureData& _textureData)
{
...
void ego::gui::ImGuiTextureStorage::release()
{
...
bool ego::gui::ImGuiTextureStorage::createTexture(ImTextureData& _textureData)
{
...
bool ego::gui::ImGuiTextureStorage::replaceTexture(ImTextureData& _textureData)
{
...
void ego::gui::ImGuiTextureStorage::destroyTexture(ImTextureData& _textureData)
{
