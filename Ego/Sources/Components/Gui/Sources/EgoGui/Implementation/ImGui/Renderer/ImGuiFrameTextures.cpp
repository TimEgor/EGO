#include "ImGuiFrameTextures.h"

#include <cstddef>

#include "EgoCore/Assert/Assert.h"

void ego::gui::ImGuiFrameTextures::reset()
{
    m_textures.clear();
}
...
bool ego::gui::ImGuiFrameTextures::resolve(GuiFrameTextureID _textureID, Texture& _texture) const
{
