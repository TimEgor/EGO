...
void ego::gui::PlatformInput::reset()
{
    m_mouseButtonsDown.fill(false);
}

void ego::gui::PlatformInput::process(const PointerMoveEvent& _event)
{
    submitModifiers(_event.m_modifiers);
    submitPointerPosition(_event.m_position, _event.m_screenPosition);
}

void ego::gui::PlatformInput::process(const PointerExitEvent& _event)
{
    submitModifiers(_event.m_modifiers);
...
void ego::gui::PlatformInput::process(const MouseButtonEvent& _event)
{
    submitModifiers(_event.m_modifiers);
    submitPointerPosition(_event.m_position, _event.m_screenPosition);
...
void ego::gui::PlatformInput::process(const MouseWheelEvent& _event)
{
    submitModifiers(_event.m_modifiers);
    submitPointerPosition(_event.m_position, _event.m_screenPosition);
...
void ego::gui::PlatformInput::process(const KeyEvent& _event)
{
    submitModifiers(_event.m_modifiers);
...
void ego::gui::PlatformInput::process(const TextInputEvent& _event)
{
    submitModifiers(_event.m_modifiers);
...
void ego::gui::PlatformInput::process(const PointerCaptureLostEvent&)
{
    releaseMouseButtons();
}

void ego::gui::PlatformInput::process(const ViewportDeactivatedEvent&)
{
    ImGui::GetIO().AddFocusEvent(false);
    reset();
}

ImGuiKey ego::gui::PlatformInput::TranslateKeyboardKey(KeyboardInputKey _key)
{
...
int ego::gui::PlatformInput::TranslateMouseButton(MouseInputKey _key)
{
    switch (_key)
    {
...
uint32_t ego::gui::PlatformInput::NormalizeCodepoint(uint32_t _codepoint)
{
...
void ego::gui::PlatformInput::submitModifiers(const InputModifiers& _modifiers)
{
    ImGuiIO& io = ImGui::GetIO();
...
void ego::gui::PlatformInput::submitPointerPosition(const FloatVector2& _position, const FloatVector2& _screenPosition)
{
    ImGuiIO& io = ImGui::GetIO();
...
void ego::gui::PlatformInput::releaseMouseButtons()
{
