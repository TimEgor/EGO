...
namespace ego
{
    ...
    ComputeMatrix4x4Base<T>& ComputeMatrix4x4Base<T>::operator*=(const ComputeMatrix4x4Base<T>& _matrix)
    {
        ...
        result.m_matrix[0][0] =
            m_matrix[0][0] * _matrix.m_matrix[0][0] + m_matrix[1][0] * _matrix.m_matrix[0][1] + m_matrix[2][0] * _matrix.m_matrix[0][2] + m_matrix[3][0] * _matrix.m_matrix[0][3];
        result.m_matrix[0][1] =
            m_matrix[0][1] * _matrix.m_matrix[0][0] + m_matrix[1][1] * _matrix.m_matrix[0][1] + m_matrix[2][1] * _matrix.m_matrix[0][2] + m_matrix[3][1] * _matrix.m_matrix[0][3];
        result.m_matrix[0][2] =
            m_matrix[0][2] * _matrix.m_matrix[0][0] + m_matrix[1][2] * _matrix.m_matrix[0][1] + m_matrix[2][2] * _matrix.m_matrix[0][2] + m_matrix[3][2] * _matrix.m_matrix[0][3];
        result.m_matrix[0][3] =
            m_matrix[0][3] * _matrix.m_matrix[0][0] + m_matrix[1][3] * _matrix.m_matrix[0][1] + m_matrix[2][3] * _matrix.m_matrix[0][2] + m_matrix[3][3] * _matrix.m_matrix[0][3];

        result.m_matrix[1][0] =
            m_matrix[0][0] * _matrix.m_matrix[1][0] + m_matrix[1][0] * _matrix.m_matrix[1][1] + m_matrix[2][0] * _matrix.m_matrix[1][2] + m_matrix[3][0] * _matrix.m_matrix[1][3];
        result.m_matrix[1][1] =
            m_matrix[0][1] * _matrix.m_matrix[1][0] + m_matrix[1][1] * _matrix.m_matrix[1][1] + m_matrix[2][1] * _matrix.m_matrix[1][2] + m_matrix[3][1] * _matrix.m_matrix[1][3];
        result.m_matrix[1][2] =
            m_matrix[0][2] * _matrix.m_matrix[1][0] + m_matrix[1][2] * _matrix.m_matrix[1][1] + m_matrix[2][2] * _matrix.m_matrix[1][2] + m_matrix[3][2] * _matrix.m_matrix[1][3];
        result.m_matrix[1][3] =
            m_matrix[0][3] * _matrix.m_matrix[1][0] + m_matrix[1][3] * _matrix.m_matrix[1][1] + m_matrix[2][3] * _matrix.m_matrix[1][2] + m_matrix[3][3] * _matrix.m_matrix[1][3];

        result.m_matrix[2][0] =
            m_matrix[0][0] * _matrix.m_matrix[2][0] + m_matrix[1][0] * _matrix.m_matrix[2][1] + m_matrix[2][0] * _matrix.m_matrix[2][2] + m_matrix[3][0] * _matrix.m_matrix[2][3];
        result.m_matrix[2][1] =
            m_matrix[0][1] * _matrix.m_matrix[2][0] + m_matrix[1][1] * _matrix.m_matrix[2][1] + m_matrix[2][1] * _matrix.m_matrix[2][2] + m_matrix[3][1] * _matrix.m_matrix[2][3];
        result.m_matrix[2][2] =
            m_matrix[0][2] * _matrix.m_matrix[2][0] + m_matrix[1][2] * _matrix.m_matrix[2][1] + m_matrix[2][2] * _matrix.m_matrix[2][2] + m_matrix[3][2] * _matrix.m_matrix[2][3];
        result.m_matrix[2][3] =
            m_matrix[0][3] * _matrix.m_matrix[2][0] + m_matrix[1][3] * _matrix.m_matrix[2][1] + m_matrix[2][3] * _matrix.m_matrix[2][2] + m_matrix[3][3] * _matrix.m_matrix[2][3];

        result.m_matrix[3][0] =
            m_matrix[0][0] * _matrix.m_matrix[3][0] + m_matrix[1][0] * _matrix.m_matrix[3][1] + m_matrix[2][0] * _matrix.m_matrix[3][2] + m_matrix[3][0] * _matrix.m_matrix[3][3];
        result.m_matrix[3][1] =
            m_matrix[0][1] * _matrix.m_matrix[3][0] + m_matrix[1][1] * _matrix.m_matrix[3][1] + m_matrix[2][1] * _matrix.m_matrix[3][2] + m_matrix[3][1] * _matrix.m_matrix[3][3];
        result.m_matrix[3][2] =
            m_matrix[0][2] * _matrix.m_matrix[3][0] + m_matrix[1][2] * _matrix.m_matrix[3][1] + m_matrix[2][2] * _matrix.m_matrix[3][2] + m_matrix[3][2] * _matrix.m_matrix[3][3];
        result.m_matrix[3][3] =
            m_matrix[0][3] * _matrix.m_matrix[3][0] + m_matrix[1][3] * _matrix.m_matrix[3][1] + m_matrix[2][3] * _matrix.m_matrix[3][2] + m_matrix[3][3] * _matrix.m_matrix[3][3];
    ...
    {
        const T det0 = m_matrix[1][1] * (m_matrix[2][2] * m_matrix[3][3] - m_matrix[3][2] * m_matrix[2][3]) -
        ...
        const T det1 = m_matrix[0][1] * (m_matrix[2][2] * m_matrix[3][3] - m_matrix[3][2] * m_matrix[2][3]) -
        ...
        const T det2 = m_matrix[0][1] * (m_matrix[1][2] * m_matrix[3][3] - m_matrix[3][2] * m_matrix[1][3]) -
        ...
        const T det3 = m_matrix[0][1] * (m_matrix[1][2] * m_matrix[2][3] - m_matrix[2][2] * m_matrix[1][3]) -
    ...
    {
        if (m_column1.isEqual(_matrix.m_column1, _epsilon))
        {
            return false;
        }
        if (m_column2.isEqual(_matrix.m_column2, _epsilon))
        {
            return false;
        }
        if (m_column3.isEqual(_matrix.m_column3, _epsilon))
        {
            return false;
        }
        if (m_column4.isEqual(_matrix.m_column4, _epsilon))
        {
            return false;
        }
    ...
    {
        return ComputeMatrix4x4Base<
            T>(T(0.0), _vector[2], -_vector[1], T(0.0), -_vector[2], T(0.0), _vector[0], T(0.0), _vector[1], -_vector[0], T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(1.0));
    }
