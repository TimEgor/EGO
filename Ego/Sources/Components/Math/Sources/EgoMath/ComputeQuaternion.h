...
namespace ego
{
	...
	public:
		...
		ValueType getElement(uint32_t _index) const { return m_quaternion.m_elements.getElement(_index); }
		ValueType& getElement(uint32_t _index) { return m_quaternion.m_elements.getElement(_index); }
		...
		void setX(ValueType _value) { m_quaternion.m_elements.m_x = _value; }
		void setY(ValueType _value) { m_quaternion.m_elements.m_y = _value; }
		void setZ(ValueType _value) { m_quaternion.m_elements.m_z = _value; }
		void setW(ValueType _value) { m_quaternion.m_elements.m_w = _value; }
	...
	template <typename T>
	ComputeVector3Base<T> EulerAnglesFromQuaternion(const ComputeQuaternionBase<T>& _rotation) { return _rotation.getEulerAngles(); }
