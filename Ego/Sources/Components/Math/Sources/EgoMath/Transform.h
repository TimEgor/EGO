...
namespace ego
{
    ...
    struct Transform final
    {
        ...
        Transform() = default;
        Transform(const TransformMatrix& matrix)
            : m_matrix(matrix)
        {
        }
        ...
        void setAxisX(const ComputeVector3& axis)
        {
        ...
        void setAxisY(const ComputeVector3& axis)
        {
        ...
        void setAxisZ(const ComputeVector3& axis)
        {
        ...
        void setOrigin(const ComputeVector3& origin)
        {
            m_matrix.getColumn(3).setXYZ(origin);
        }
