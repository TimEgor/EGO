...
namespace ego
{
	...
	struct Matrix2x2Base final
	{
		...
		constexpr Matrix2x2Base(
			ValueType _m11, ValueType _m12,
			ValueType _m21, ValueType _m22)
			: m_m11(_m11), m_m12(_m12),
			m_m21(_m21), m_m22(_m22) {}

		constexpr Matrix2x2Base(const RowVectorType& _row1, const RowVectorType& _row2)
			: m_row1(_row1), m_row2(_row2) {}

		constexpr Matrix2x2Base(const Matrix2x2Base& _matrix)
			: m_row1(_matrix.m_row1), m_row2(_matrix.m_row2) {}
	...
	struct Matrix4x4Base final
	{
		...
		constexpr Matrix4x4Base(
			ValueType _m11, ValueType _m12, ValueType _m13, ValueType _m14,
			ValueType _m21, ValueType _m22, ValueType _m23, ValueType _m24,
			ValueType _m31, ValueType _m32, ValueType _m33, ValueType _m34,
			ValueType _m41, ValueType _m42, ValueType _m43, ValueType _m44)
			: m_m11(_m11), m_m12(_m12), m_m13(_m13), m_m14(_m14),
			m_m21(_m21), m_m22(_m22), m_m23(_m23), m_m24(_m24),
			m_m31(_m31), m_m32(_m32), m_m33(_m33), m_m34(_m34),
			m_m41(_m41), m_m42(_m42), m_m43(_m43), m_m44(_m44) {}

		constexpr Matrix4x4Base(const RowVectorType& _row1, const RowVectorType& _row2,
			const RowVectorType& _row3, const RowVectorType& _row4)
			: m_row1(_row1), m_row2(_row2), m_row3(_row3), m_row4(_row4) {}
		...
		constexpr Matrix4x4Base(const Matrix4x4Base& _matrix)
			: m_row1(_matrix.m_row1), m_row2(_matrix.m_row2), m_row3(_matrix.m_row3), m_row4(_matrix.m_row4) {}
