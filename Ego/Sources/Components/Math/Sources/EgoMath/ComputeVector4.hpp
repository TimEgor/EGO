namespace ego
{
    ...
    {
        return m_vector.m_x * _vector.m_vector.m_x + m_vector.m_y * _vector.m_vector.m_y + m_vector.m_z * _vector.m_vector.m_z + m_vector.m_w * _vector.m_vector.m_w;
    }
    ...
    bool ComputeVector4Base<T>::isEqual(const ComputeVector4Base<T>& _vector, T _epsilon) const
    {
        return math::IsApproxEqual(m_vector.m_x, _vector.m_vector.m_x, _epsilon) && math::IsApproxEqual(m_vector.m_y, _vector.m_vector.m_y, _epsilon) &&
               math::IsApproxEqual(m_vector.m_z, _vector.m_vector.m_z, _epsilon) && math::IsApproxEqual(m_vector.m_w, _vector.m_vector.m_w, _epsilon);
    }
    ...
    bool ComputeVector4Base<T>::isLess(const ComputeVector4Base<T>& _vector, T _epsilon) const
    {
        return math::IsApproxLess(m_vector.m_x, _vector.m_vector.m_x, _epsilon) && math::IsApproxLess(m_vector.m_y, _vector.m_vector.m_y, _epsilon) &&
               math::IsApproxLess(m_vector.m_z, _vector.m_vector.m_z, _epsilon) && math::IsApproxLess(m_vector.m_w, _vector.m_vector.m_w, _epsilon);
    }
    ...
    bool ComputeVector4Base<T>::isLessOrEqual(const ComputeVector4Base<T>& _vector, T _epsilon) const
    {
        return math::IsApproxLessOrEqual(m_vector.m_x, _vector.m_vector.m_x, _epsilon) && math::IsApproxLessOrEqual(m_vector.m_y, _vector.m_vector.m_y, _epsilon) &&
               math::IsApproxLessOrEqual(m_vector.m_z, _vector.m_vector.m_z, _epsilon) && math::IsApproxLessOrEqual(m_vector.m_w, _vector.m_vector.m_w, _epsilon);
    }
    ...
    bool ComputeVector4Base<T>::isGreater(const ComputeVector4Base<T>& _vector, T _epsilon) const
    {
        return math::IsApproxGreater(m_vector.m_x, _vector.m_vector.m_x, _epsilon) && math::IsApproxGreater(m_vector.m_y, _vector.m_vector.m_y, _epsilon) &&
               math::IsApproxGreater(m_vector.m_z, _vector.m_vector.m_z, _epsilon) && math::IsApproxGreater(m_vector.m_w, _vector.m_vector.m_w, _epsilon);
    }
    ...
    bool ComputeVector4Base<T>::isGreaterOrEqual(const ComputeVector4Base<T>& _vector, T _epsilon) const
    {
        return math::IsApproxGreaterOrEqual(m_vector.m_x, _vector.m_vector.m_x, _epsilon) && math::IsApproxGreaterOrEqual(m_vector.m_y, _vector.m_vector.m_y, _epsilon) &&
               math::IsApproxGreaterOrEqual(m_vector.m_z, _vector.m_vector.m_z, _epsilon) && math::IsApproxGreaterOrEqual(m_vector.m_w, _vector.m_vector.m_w, _epsilon);
    }
