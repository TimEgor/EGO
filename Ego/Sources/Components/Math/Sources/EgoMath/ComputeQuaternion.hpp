...
namespace ego
{
	...
	{
		const T x =
			m_quaternion.m_elements.m_w * _quaternion.m_quaternion.m_elements.m_x +
			m_quaternion.m_elements.m_x * _quaternion.m_quaternion.m_elements.m_w +
			m_quaternion.m_elements.m_y * _quaternion.m_quaternion.m_elements.m_z -
			m_quaternion.m_elements.m_z * _quaternion.m_quaternion.m_elements.m_y;
		const T y =
			m_quaternion.m_elements.m_w * _quaternion.m_quaternion.m_elements.m_y -
			m_quaternion.m_elements.m_x * _quaternion.m_quaternion.m_elements.m_z +
			m_quaternion.m_elements.m_y * _quaternion.m_quaternion.m_elements.m_w +
			m_quaternion.m_elements.m_z * _quaternion.m_quaternion.m_elements.m_x;
		const T z =
			m_quaternion.m_elements.m_w * _quaternion.m_quaternion.m_elements.m_z +
			m_quaternion.m_elements.m_x * _quaternion.m_quaternion.m_elements.m_y -
			m_quaternion.m_elements.m_y * _quaternion.m_quaternion.m_elements.m_x +
			m_quaternion.m_elements.m_z * _quaternion.m_quaternion.m_elements.m_w;
		const T w =
			m_quaternion.m_elements.m_w * _quaternion.m_quaternion.m_elements.m_w -
			m_quaternion.m_elements.m_x * _quaternion.m_quaternion.m_elements.m_x -
			m_quaternion.m_elements.m_y * _quaternion.m_quaternion.m_elements.m_y -
			m_quaternion.m_elements.m_z * _quaternion.m_quaternion.m_elements.m_z;
	...
	ComputeQuaternionBase<T>& ComputeQuaternionBase<T>::setupFromRotationMatrix4x4(const ComputeMatrix4x4Base<T>& _matrix)
	{
		setupFromRotationMatrix3x3(
			ComputeMatrix3x3Base<T>(
				_matrix.getColumn(0).getXYZ(),
				_matrix.getColumn(1).getXYZ(),
				_matrix.getColumn(2).getXYZ()
			)
		);
	...
	{
		return
			math::IsApproxEqual(m_quaternion.m_elements.m_x, _quaternion.m_quaternion.m_elements.m_x, _epsilon) &&
