...
namespace ego
{
    ...
    public:
        ...
        bool isLess(const ComputeVector2Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this < vector
        bool isLessOrEqual(const ComputeVector2Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this <= vector
        bool isGreater(const ComputeVector2Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this > vector
        bool isGreaterOrEqual(const ComputeVector2Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this >= vector
    ...
    template <typename T>
    constexpr ComputeVector2Base<T> ComputeVector2ZeroBase()
    {
        return ComputeVector2Base<T>(0.0);
    }
    template <typename T>
    constexpr ComputeVector2Base<T> ComputeVector2OneBase()
    {
        return ComputeVector2Base<T>(1.0);
    }
    template <typename T>
    constexpr ComputeVector2Base<T> ComputeVector2NegativeOneBase()
    {
        return ComputeVector2Base<T>(-1.0);
    }

    template <typename T>
    constexpr ComputeVector2Base<T> ComputeVector2EpsilonBase()
    {
