...
namespace ego
{
    ...
    public:
        ...
        constexpr ComputeMatrix3x3Base(
            ...
            ValueType _m32,
            ValueType _m33)
            : m_matrix(_m11, _m12, _m13, _m21, _m22, _m23, _m31, _m32, _m33)
        {
        }
        ...
        constexpr ComputeMatrix3x3Base(const ComputeVector3Base<ValueType>& _column1, const ComputeVector3Base<ValueType>& _column2, const ComputeVector3Base<ValueType>& _column3)
            : m_column1(_column1),
              m_column2(_column2),
              m_column3(_column3)
        {
