...
namespace ego
{
    ...
    public:
        ...
        bool isLess(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this < vector
        bool isLessOrEqual(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this <= vector
        bool isGreater(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this > vector
        bool isGreaterOrEqual(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this >= vector
        bool isAnyLess(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this < vector
        bool isAnyLessOrEqual(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this <= vector
        bool isAnyGreater(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this > vector
        bool isAnyGreaterOrEqual(const ComputeVector3Base& _vector,
            ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this >= vector
    ...
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3ZeroBase()
    {
        return ComputeVector3Base<T>(0.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3OneBase()
    {
        return ComputeVector3Base<T>(1.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3NegativeOneBase()
    {
        return ComputeVector3Base<T>(-1.0);
    }

    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3EpsilonBase()
    {
        return ComputeVector3Base<T>(math::TypedEpsilon<T>());
    }

    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3UnitXBase()
    {
        return ComputeVector3Base<T>(1.0, 0.0, 0.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3UnitYBase()
    {
        return ComputeVector3Base<T>(0.0, 1.0, 0.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3UnitZBase()
    {
        return ComputeVector3Base<T>(0.0, 0.0, 1.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3NegativeUnitXBase()
    {
        return ComputeVector3Base<T>(-1.0, 0.0, 0.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3NegativeUnitYBase()
    {
        return ComputeVector3Base<T>(0.0, -1.0, 0.0);
    }
    template <typename T>
    constexpr ComputeVector3Base<T> ComputeVector3NegativeUnitZBase()
    {
        return ComputeVector3Base<T>(0.0, 0.0, -1.0);
    }
