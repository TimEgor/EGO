...
namespace ego
{
	...
	public:
		...
		void setW(ValueType _value) { m_vector.m_w = _value; }
		...
		void setZW(const ComputeVector2Base<ValueType>& _vector) { m_vectorZW = _vector; }

		const ComputeVector3Base<ValueType>& getXYZ() const { return m_vectorXYZ; }
		ComputeVector3Base<ValueType>& getXYZ() { return m_vectorXYZ; }
		void setXYZ(const ComputeVector3Base<ValueType>& _vector) { m_vectorXYZ = _vector; }
		...
		bool isLess(const ComputeVector4Base& _vector, ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this < vector
		bool isLessOrEqual(const ComputeVector4Base& _vector, ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this <= vector
		bool isGreater(const ComputeVector4Base& _vector, ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this > vector
		bool isGreaterOrEqual(const ComputeVector4Base& _vector, ValueType _epsilon = math::TypedEpsilon<ValueType>()) const; // *this >= vector
