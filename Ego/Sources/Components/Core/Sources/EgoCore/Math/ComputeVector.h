...
namespace ego
{
    ...
    public:
        ...
        static constexpr uint32_t NativeElementCount = math::simd::NativeComputeVectorElementCount;
        ...
        ComputeVectorBase(ValueType _x, ValueType _y) requires(Size == 2);
        ComputeVectorBase(ValueType _x, ValueType _y, ValueType _z) requires(Size == 3);
        ComputeVectorBase(ValueType _x, ValueType _y, ValueType _z, ValueType _w) requires(Size == 4);
        template <typename SourceValueType>
        ComputeVectorBase(const Vector2Base<SourceValueType>& _vector) requires(Size == 2);
        template <typename SourceValueType>
        ComputeVectorBase(const Vector3Base<SourceValueType>& _vector) requires(Size == 3);
        template <typename SourceValueType>
        ComputeVectorBase(const Vector4Base<SourceValueType>& _vector) requires(Size == 4);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 2>& _vector, ValueType _z) requires(Size == 3);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 2>& _vector1, const ComputeVectorBase<ValueType, 2>& _vector2) requires(Size == 4);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 2>& _vector, ValueType _z, ValueType _w) requires(Size == 4);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 2>& _vector) requires(Size == 3 || Size == 4);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 3>& _vector) requires(Size == 4);
        ComputeVectorBase(const ComputeVectorBase<ValueType, 3>& _vector, ValueType _w) requires(Size == 4);
        ...
        ValueType getZ() const requires(Size >= 3);
        ValueType getW() const requires(Size == 4);

        void setX(ValueType _value);
        void setY(ValueType _value);
        void setZ(ValueType _value) requires(Size >= 3);
        void setW(ValueType _value) requires(Size == 4);

        ComputeVectorBase<ValueType, 2> getXY() const requires(Size >= 3);
        ComputeVectorBase<ValueType, 2> getZW() const requires(Size == 4);
        ComputeVectorBase<ValueType, 3> getXYZ() const requires(Size == 4);

        void setXY(const ComputeVectorBase<ValueType, 2>& _vector) requires(Size >= 3);
        void setZW(const ComputeVectorBase<ValueType, 2>& _vector) requires(Size == 4);
        void setXYZ(const ComputeVectorBase<ValueType, 3>& _vector) requires(Size == 4);

        ValueType getLength() const;
        ValueType getLengthSqr() const;

        ComputeVectorBase& negate();
        ComputeVectorBase& computeReciprocal() requires(Size == 3);
        ComputeVectorBase& multiplyElements(const ComputeVectorBase& _vector) requires(Size == 3);

        ComputeVectorBase getUnit() const;
        void getUnit(ComputeVectorBase& _out) const requires(Size == 3);
        ComputeVectorBase& normalize();

        ComputeVectorBase getOrthogonal() const requires(Size == 3);
        void getOrthogonal(ComputeVectorBase& _out) const requires(Size == 3);

        ComputeVectorBase getAbs() const requires(Size == 3);
        void getAbs(ComputeVectorBase& _out) const requires(Size == 3);

        uint32_t getMinElementIndex() const requires(Size == 3);
        uint32_t getMaxElementIndex() const requires(Size == 3);

        ValueType dot(const ComputeVectorBase& _vector) const;
        ComputeVectorBase cross(const ComputeVectorBase& _vector) const requires(Size == 3);

        ComputeVectorBase swizzle(uint32_t _index1, uint32_t _index2, uint32_t _index3) const requires(Size == 3);
