...
namespace ego
{
    ...
    public:
        ...
        bool removeResourceProvider(const FileName& _extension, const ResourceProviderPointer& _provider);
        ...
        SharedPointer<TResource> load(const FileName& _path)
        {
            ...
            const ResourceControllerWeakPointer controller = weakFromThis();
