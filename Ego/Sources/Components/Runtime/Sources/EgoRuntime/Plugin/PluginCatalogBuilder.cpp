...
size_t ego::PluginCatalogBuilder::AddPluginsFromPath(PluginCatalog& _catalog, const FileSystem& _fileSystem, const FileName& _path, bool _recursive)
{
    if (!_path)
    {
        return 0;
...
size_t ego::PluginCatalogBuilder::AddPluginsFromManifest(PluginCatalog& _catalog, const FileSystem& _fileSystem, const FileName& _manifestPath)
{
    std::string content;
...
size_t ego::PluginCatalogBuilder::AddPluginsFromManifestNode(PluginCatalog& _catalog, const XmlNode& _manifestNode, const FileName& _moduleName)
{
...
bool ego::PluginCatalogBuilder::AddPluginFromNode(PluginCatalog::Entry& _entry, const XmlNode& _pluginNode)
{
